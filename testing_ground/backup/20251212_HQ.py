...
negative_sampling_modes = ["HQ"]

early_stop_modes = [("AUROC", "max")]
...
output_dir = "/data/home/natant/Negatives/Runs/Review_sane_model/other_cell_lines"

# Define the group name
wandb_project = "Negatives_calibration"
group_name = "Sane_model_take_2"
...
cell_tf_neg_combinations = [
    (cell_type, tf, neg_mode, i, early_stop_metric, early_stop_mode, lr)
...
def worker():
    while not queue.empty():
        cell_type, tf, neg_mode, set, es_metric, es_mode, lr = queue.get()
        command = [
            "python", 
            "/data/home/natant/Negatives/TFBS_negatives/utils/train_sane_model_HQ.py",
