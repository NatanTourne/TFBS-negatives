...
all_runs_df = pd.read_pickle('/data/home/natant/Negatives/testing_ground/REVIEW_cross_cell_perf/20251120_all_cross_cell_runs_HQ.pkl')
...
def worker():
    while not queue.empty():
        ...
        command = [
            "python", 
            "/data/home/natant/Negatives/testing_ground/REVIEW_cross_cell_perf/Test_ckpt_HQ.py",
            "--ckpt_path", file_path,
