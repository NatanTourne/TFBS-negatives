...
df_all_metrics_cleaned.to_pickle(os.path.join(out_folder, 'GM12878_MOTIFS_full.pkl'))

print(f"Dataframe saved to {os.path.join(out_folder, 'GM12878_MOTIFS_full.pkl')}")
