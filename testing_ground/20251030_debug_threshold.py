...
if __name__ == "__main__":
    ...
    args.TF = "CTCF"
    args.celltype = "K562"
    args.neg_mode = "dinucl_sampled"
    args.devices = [1]
    args.batch_size = 256
    args.learning_rate = 0.0001
    args.n_blocks = 2
    args.target_hsize = 128
    args.group_name = "debug_threshold"
    args.output_dir = "/data/home/natant/Negatives/testing_ground/junk"
    args.early_stop_patience = 30
    args.early_stop_metric = "AUROC"
    args.early_stop_mode = "max"
    args.cross_val_set = 0
    args.datafolder = "/data/home/natant/Negatives/Data/Encode690/ENCODE_hg38_subset_101bp_celltypes_ATAC_H5_all_chr/"
