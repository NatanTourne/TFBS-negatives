...
output_folder = "/data/home/natant/Negatives/Data/Encode690_big/ENCODE_hg38_subset_101bp"
...
df_filtered = df_filtered_cells .merge(matched_cells, left_on='cell', right_on='df_cell', how='left')
