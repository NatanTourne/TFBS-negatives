...
if __name__ == "__main__":
    ...
    model = TFmodel2(learning_rate=args.learning_rate)
    ...
    run_name = f"{args.celltype}_{args.TF}_{args.neg_mode}_CV{args.cross_val_set}_{date}"
    ...
    if args.test:
        ...
        if best_model_path:
            ...
            best_model = TFmodel2.load_from_checkpoint(best_model_path)
